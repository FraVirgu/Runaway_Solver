...
int main(int argc, char *argv[])
{
    ...
    // Destroy PETSc-backed objects (Simulation -> EquationSystem -> Solver,
    // whose destructors call PETSc Vec/Mat/KSP destroy routines) before
    // finalizing PETSc/MPI. Doing this after dream_finalize() calls PETSc
    // functions on a torn-down MPI communicator, which aborts.
    delete sim;
    delete a;
