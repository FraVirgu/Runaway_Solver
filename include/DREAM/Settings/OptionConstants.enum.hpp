...
enum uqty_f_hot_dist_mode
{                                   // Model used for analytic hottail distribution
...
enum collqty_pstar_mode
{                                        // Runaway growth rates are determined from dynamics that are
...
enum collqty_screened_diffusion_mode
{                                                  // The energy diffusion frequency due to bound electrons are
...
enum eqterm_avalanche_mode
{                                            // Avalanche generation is...
...
enum eqterm_nonlinear_mode
{                                                // Non-linear self-collisions are...
...
{                                                  // Bremsstrahlung radiation reaction is...
...
enum eqterm_ionization_mode
{                                                  // Ionization is modelled with...
...
enum eqterm_particle_source_mode
{                                        // Equation used for S_particle (the kinetic particle source)
...
enum eqterm_hottail_mode
{                                            // Mode used for hottail runaway generation
...
enum eqterm_tritium_mode
{                                    // Tritium generation is...
